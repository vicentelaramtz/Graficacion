...
public class CamCap extends javax.swing.JFrame {
    ...
    String File_path = "";
    String base_path = "./data/cascades/";   // Carpeta donde se localizan los modelos de reconocimiento
    String faceFile = "haarcascade_plant.xml";  // Archivo referencia para reconocimiento de rostros
